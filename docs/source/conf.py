...
project = "dreye"
copyright = f"2020-{datetime.now().year}, Matthias Christenson"
...
import dreye  # noqa: E402 isort:skip

# version = '%s r%s' % (dreye.__version__, svn_version())
version = str(dreye.__version__)
...
html_theme_options = {
    ...
    # "twitter_url": "https://twitter.com/gucky92",
...
latex_documents = [
    (
        "index",
        "dreye.tex",
        "dreye: Handling puffy dataframes",
...
# extlinks alias
extlinks = {
    "issue": ("https://github.com/gucky92/dreye/issues/%s", "GH"),
    "wiki": ("https://github.com/gucky92/dreye/wiki/%s", "wiki "),
}
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(dreye.__file__))

    if "+" in dreye.__version__:
        return f"https://github.com/gucky92/dreye/blob/master/dreye/{fn}{linespec}"
    else:
        return (
            f"https://github.com/gucky92/dreye/blob/"
            f"v{dreye.__version__}/dreye/{fn}{linespec}"
        )
